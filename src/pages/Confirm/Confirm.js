    ...
    <div className="payment">
            <div className="payment-page">
                <div className="payment-texts">
                    <div className="payment-texts-top">
                        <p className="payment-white-text">Mahsulot soni:</p>
                        <p className="payment-cost">5 dona</p>
                    </div>
                    <div className="payment-texts-bottom">
                        <p className="payment-white-text">Narxi:</p>
                        <p className="payment-cost"> 1 795 515 so’m</p>
                    </div>
                    <div className="payment-input-top">
                    <input type="text" placeholder="Manzilni to‘liq kiriting" />
                        <button className="button-click">
                            <img src={Click} alt="logo click" />
                        </button>
                        <button className="button-payme">
                            <img src={Payme} alt="logo payme" />
                        </button>
                    </div>
                    <div className="payment-input-bottom">
                        <div className="payment-labels">
                            <label htmlFor="">Karta raqamini kiriting: </label>
                            <input className="card-number" type="number" placeholder="1234 1234 1234 1234" max="9" min={0}/>
                        </div>
